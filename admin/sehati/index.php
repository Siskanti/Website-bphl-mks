<?php 
	...
	$sql = mysqli_query($con, "SELECT * FROM tbl_sehati");
...
if(isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con, "UPDATE tbl_sehati SET  judul='$judul', artikel='$artikel' WHERE id_sehati='$id'");

    // $sql = mysqli_query($con, "INSERT INTO tbl_sehati VALUES ('',  '$judul', '$artikel', '$date',  '$author')");
