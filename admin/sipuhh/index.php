...
$sql = mysqli_query($con, "SELECT * FROM tbl_sipuhh");
...
if (isset($_POST['submit'])) {
	...
	$sql = mysqli_query($con, "UPDATE tbl_sipuhh SET  judul='$judul', artikel='$artikel' WHERE id_sipuhh='$id'");

	// $sql = mysqli_query($con, "INSERT INTO tbl_sipuhh VALUES ('',  '$judul', '$artikel', '$date',  '$author')");
	echo "<script>alert('Data Berhasil Ditambahkan!')</script>";
	echo "<script>window.location.href='index.php?page=sipuhh'</script>";
	// $id = $_GET['id_kph']
