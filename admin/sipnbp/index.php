<?php 
	...
	$sql = mysqli_query($con, "SELECT * FROM tbl_sipnbp");
...
if(isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con, "UPDATE tbl_sipnbp SET  judul='$judul', artikel='$artikel' WHERE id_sipnbp='$id'");

    // $sql = mysqli_query($con, "INSERT INTO tbl_sipnbp VALUES ('',  '$judul', '$artikel', '$date',  '$author')");
