<?php 
	...
	$sql = mysqli_query($con, "SELECT * FROM tbl_sirpbbi");
...
if(isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con, "UPDATE tbl_sirpbbi SET  judul='$judul', artikel='$artikel' WHERE id_sirpbbi='$id'");
    // $sql = mysqli_query($con, "INSERT INTO tbl_sirpbbi VALUES ('',  '$judul', '$artikel', '$date',  '$author')");
