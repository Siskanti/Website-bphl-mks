...
<head>
  ...
  <title>Dashboard | Sisfo Unhas</title>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Sisfo Unhas</span>
      </a>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php if ($_SESSION['lvluser'] == 1) { ?>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="index.php?page=data-kepalabalai" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Data pimpinan</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="index.php?page=tambah-kepalabalai" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Tambah data</p>
                    </a>
                  </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="index.php?page=data-aturan" class="nav-link">
                    <i class="far fa-dot-circle nav-icon"></i>
                    <p>Data aturan</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="index.php?page=tambah-aturan" class="nav-link">
                    <i class="far fa-dot-circle nav-icon"></i>
                    <p>Tambah aturan</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="index.php?page=kph" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                      KPH
                      <i class="right fas fa-angle-left"></i>
                ...
                <li class="nav-item">
                  <a href="index.php?page=siganishut" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                      siganishut
                      <i class="right fas fa-angle-left"></i>
                ...
                <li class="nav-item">
                  <a href="index.php?page=sipuhh" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                      sipuhh
                      <i class="right fas fa-angle-left"></i>
                ...
                <li class="nav-item">
                  <a href="index.php?page=sirpbbi" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                      sirpbbi
                      <i class="right fas fa-angle-left"></i>
                ...
                <li class="nav-item">
                  <a href="index.php?page=sipnbp" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                      sipnbp
                      <i class="right fas fa-angle-left"></i>
                ...
                <li class="nav-item">
                  <a href="index.php?page=sehati" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                      sehati
                      <i class="right fas fa-angle-left"></i>
                ...
                <li class="nav-item">
                  <a href="index.php?page=sicakap" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                      sicakap
                      <i class="right fas fa-angle-left"></i>
