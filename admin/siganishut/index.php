	...
	<div class="col-lg-10 m-auto">
		<div class="card card-primary">
			<div class="card-header">
				<h5>Form Siganishut <?= $_GET['page'] ?></h5>
			</div>
			<div class="card-body">
...
if(isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con, "UPDATE tbl_siganishut SET  judul='$judul', artikel='$artikel' WHERE id_siganishut='$id'");

    // $sql = mysqli_query($con, "INSERT INTO tbl_siganishut VALUES ('',  '$judul', '$artikel', '$date',  '$author')");
