...
<div class="row">
	<div class="col-lg-4 col-xs-12">
		<div class="card card-primary">
			...
			<div class="card-body">
				<embed type="application/pdf" src="../assets/file/pdf/peraturan/<?= $data['pdf'] ?>" style="width: 100%;height: 30vh;"></embed>
			</div>
		</div>
	</div>
		...
		if(!empty($gambar)) {
			if(in_array($ekstensi, $ekstensi_boleh) === true) {
				if($ukuran < 5000000) {
					...
					$sql = mysqli_query($con, "UPDATE tbl_peraturan SET pdf='$gambar'");
